...
| Projects | `/projects/` | `_projects/`, `_includes/project_timeline.liquid`, `_sass/_project-timeline.scss` |
| Blog     | `/blog/`     | `_posts/`, `_includes/blog_list_by_year.liquid`                                   |
| About    | `/about/`    | `_pages/about.md`                                                                 |
| CV (PDF) | external     | `_config.yml` → `cv_pdf`; `_pages/cv.md` (navbar stub)                            |
